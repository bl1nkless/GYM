...
import BottomNavPortal from "@/components/BottomNavPortal";
...
export function BottomNav() {
  ...
  return (
    <BottomNavPortal>
      <nav
        id="tg-bottom-nav"
        className="fixed inset-x-0 bottom-0 z-[1000] border-t border-zinc-800 bg-black/90 pb-[calc(env(safe-area-inset-bottom,0px)+12px)] backdrop-blur-lg"
      >
